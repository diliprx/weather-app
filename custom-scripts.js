...
const insertStickyAd=()=>{const stickyBtmAd=document.createElement("div");stickyBtmAd.classList.add("sticky-bottom-ad");stickyBtmAd.innerHTML=`<div class="ad-body">
                                <div class="close-btn">
...
const insertLinkAndScript=()=>{const isCustomLinkExist=document.querySelector('link[href="../custom-styles.css"]');if(!isCustomLinkExist){const customLink=document.createElement("link");customLink.rel="stylesheet";customLink.href="../custom-styles.css";document.head.appendChild(customLink);}
